...
def train():
    ...
    with tf.name_scope('get_batch'):
        ...
        # print(gtboxes_and_label_AreaRectangle)
        # print(gtboxes_and_label_AreaRectangle.shape)
            ...
            if step % cfgs.SHOW_TRAIN_INFO_INTE != 0 and step % cfgs.SMRY_ITER != 0:
                ...
                if step % cfgs.SHOW_TRAIN_INFO_INTE == 0 and step % cfgs.SMRY_ITER != 0:
                    ...
                    print(""" {}: step{}    image_name:{} |\t
                                                    ...
                                                    fast_rcnn_loc_loss:{} |\t 
                                                    fast_rcnn_cla_loss:{} |\t
                                                    fast_rcnn_loc_rotate_loss:{} |\t 
                                                    fast_rcnn_cla_rotate_loss:{} |\t
