...
# ------------------------------------------------
# VERSION = '20class_20190511_rotated'
if TYPE_NUMBER:
    VERSION = 'number_20190516'
    DATASET_NAME =  'NUMBER'
    IMG_SHORT_SIDE_LEN = 250
    IMG_MAX_LENGTH = 500
    CLASS_NUM = 19
else:
    VERSION = 'cs_20190520'
    IMG_SHORT_SIDE_LEN = 400
    IMG_MAX_LENGTH = 1500
    DATASET_NAME = 'METTER'
    CLASS_NUM = 1
...
SMRY_ITER = 5
SAVE_WEIGHTS_INTE = 300

SUMMARY_PATH = ROOT_PATH + '/output/summary'
TEST_SAVE_PATH = ROOT_PATH + '/tools/test_result'
INFERENCE_IMAGE_PATH = ROOT_PATH + '/tools/inference_image'
INFERENCE_SAVE_PATH = ROOT_PATH + '/tools/inference_results'
ROTATE_SAVE_PATH = ROOT_PATH + '/tools/rotate_result'
CLASSIFICATION_DATA = ROOT_PATH + '/tools/classification_data'
TEST_PATH  = ROOT_PATH + '/tools/test/'
