...
static const char __pyx_k_yangxue_FPN_v16_libs_box_utils[] = "/yangxue/FPN_v16/libs/box_utils/rbbox_overlaps.pyx";
...
static PyMethodDef __pyx_mdef_14rbbox_overlaps_1rbbx_overlaps = {"rbbx_overlaps", (PyCFunction)__pyx_pw_14rbbox_overlaps_1rbbx_overlaps, METH_VARARGS|METH_KEYWORDS, 0};
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initrbbox_overlaps(void); /*proto*/
PyMODINIT_FUNC initrbbox_overlaps(void)
#else
PyMODINIT_FUNC PyInit_rbbox_overlaps(void); /*proto*/
PyMODINIT_FUNC PyInit_rbbox_overlaps(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_rbbox_overlaps(void)", 0);
